...
function c511000859.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c511000859.filter,tp,LOCATION_GRAVE,0,1,nil,e,tp,ev/2) end
...
function c511000859.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCondition(c511000859.spcon)
	e1:SetOperation(c511000859.spop)
	e1:SetLabel(ev/2)

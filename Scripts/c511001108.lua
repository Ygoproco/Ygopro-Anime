...
function c511001108.initial_effect(c)
	...
	e1:SetTarget(c511001108.countertg)
	e1:SetOperation(c511001108.counterop)
	c:RegisterEffect(e1)
end
function c511001108.countertg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(Card.IsSetCard,tp,LOCATION_GRAVE,0,1,nil,0x34) end
	Duel.SetOperationInfo(0,CATEGORY_LEAVE_GRAVE,nil,1,tp,LOCATION_GRAVE)
end
function c511001108.counterop(e,tp,eg,ep,ev,re,r,rp)

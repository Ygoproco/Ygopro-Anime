--ヴェノム・スネーク
function c73899016.initial_effect(c)
	--add counter
	...
	e1:SetCost(c73899016.cost)
	e1:SetTarget(c73899016.target)
	e1:SetOperation(c73899016.operation)
	c:RegisterEffect(e1)
end
function c73899016.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c73899016.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c73899016.operation(e,tp,eg,ep,ev,re,r,rp)

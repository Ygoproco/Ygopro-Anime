...
function c511001289.initial_effect(c)
	--fustion material
	aux.AddFusionProcFunRep(c,c511001289.fusfilter,2,true)
	c:EnableReviveLimit()
	--attack
...
function c511001289.fusfilter(c)
	return (c:IsSetCard(0x209) or c:IsCode(79629370) or c:IsCode(33698022))
end

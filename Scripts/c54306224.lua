--ヴェノム・スワンプ
function c54306224.initial_effect(c)
	--Activate
	...
	e2:SetOperation(c54306224.acop)
	c:RegisterEffect(e2)
	--atk down
...
function c54306224.atkval(e,c)
	return c:GetCounter(0x9)*-500
end
function c54306224.acop(e,tp,eg,ep,ev,re,r,rp)

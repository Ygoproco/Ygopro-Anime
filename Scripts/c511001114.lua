...
function c511001114.initial_effect(c)
	...
	e2:SetCondition(c511001114.itselftobeastcon)
	e2:SetTarget(c511001114.itselftobeasttg)
	e2:SetOperation(c511001114.itselftobeastop)
	c:RegisterEffect(e2)
...
function c511001114.itselftobeastcon(e,c)
	return e:GetHandler():IsLocation(LOCATION_SZONE)
		and Duel.GetLocationCount(e:GetHandler():GetControler(),LOCATION_MZONE)>0
end
function c511001114.itselftobeasttg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 
	and c:IsCanBeSpecialSummoned(e,0,tp,false,false) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,c,1,0,0)
end
function c511001114.itselftobeastop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()

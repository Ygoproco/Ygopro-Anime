--デビル・コメディアン
function c81172177.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_COIN+CATEGORY_REMOVE+CATEGORY_TOGRAVE)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c81172177.target)
	e1:SetOperation(c81172177.activate)
	c:RegisterEffect(e1)
end
function c81172177.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c81172177.activate(e,tp,eg,ep,ev,re,r,rp)

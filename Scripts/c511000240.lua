...
function c511000240.initial_effect(c)
	c:EnableReviveLimit()
	c:SetUniqueOnField(1,1,511000240)
	--Special Summon with Contract with Exodia
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_SINGLE)
	e1:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e1:SetCode(EFFECT_SPSUMMON_CONDITION)
	e1:SetValue(c511000240.contract)
	c:RegisterEffect(e1)
...
function c511000240.contract(e,se,sp,st)
	return st==(SUMMON_TYPE_SPECIAL+511000241)
end

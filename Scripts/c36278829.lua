--ヴェノム・サーペント
function c36278829.initial_effect(c)
	--add counter
	...
	e1:SetTarget(c36278829.target)
	e1:SetOperation(c36278829.operation)
	c:RegisterEffect(e1)
end
function c36278829.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c36278829.operation(e,tp,eg,ep,ev,re,r,rp)

...
function c511001139.overdrivecost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c511001139.overdrivefilter,tp,LOCATION_MZONE+LOCATION_SZONE,0,1,nil) end
	local g=Duel.GetMatchingGroup(c511001139.overdrivefilter,tp,LOCATION_MZONE+LOCATION_SZONE,0,nil)

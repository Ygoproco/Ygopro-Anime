--ヴェノム・ボア
function c9284724.initial_effect(c)
	--add counter
	...
	e1:SetCost(c9284724.cost)
	e1:SetTarget(c9284724.target)
	e1:SetOperation(c9284724.operation)
	c:RegisterEffect(e1)
end
function c9284724.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c9284724.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c9284724.operation(e,tp,eg,ep,ev,re,r,rp)

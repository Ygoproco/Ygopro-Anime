...
function c511001363.ovfilter(c)
	return c:IsFaceup() and c.xyz_number and c.xyz_number>=101 and c.xyz_number<=107 and c:IsSetCard(0x1048)
end
...
function c511001363.copyop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsFaceup() then
		...
		c:CopyEffect(code,RESET_EVENT+0x1fe0000+RESET_PHASE+RESET_END)
	end
end
